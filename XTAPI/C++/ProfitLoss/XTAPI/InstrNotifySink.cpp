...
/* Assign the OnNotifyDepthData event
 */
HRESULT CInstrNotifySink::OnNotifyDepthData(XTAPI::ITTInstrNotify* pNotify,XTAPI::ITTInstrObj* pInstr)
{
	// Call the derived class function to service the callback.
	m_pCallback->CInstrNotifySink_Depth(pInstr);
	return S_OK;
}

/* Assign the OnOrderSetUpdate event
 */
HRESULT CInstrNotifySink::OnOrderSetUpdate(XTAPI::ITTInstrNotify* pNotify,XTAPI::ITTInstrObj* pInstr,XTAPI::ITTOrderSet* pOrderSet)
{
	// Call the derived class function to service the callback.
	m_pCallback->CInstrNotifySink_OrderSet(pInstr, pOrderSet);
	return S_OK;
}
