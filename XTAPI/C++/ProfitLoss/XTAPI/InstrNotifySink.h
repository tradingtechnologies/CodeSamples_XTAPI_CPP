...
public:
	...
	BEGIN_SINK_MAP(CInstrNotifySink)
		...
		SINK_ENTRY_EX(1,XTAPI::DIID__ITTInstrNotifyEvents, 4,OnOrderSetUpdate)
	END_SINK_MAP()
	...
	HRESULT __stdcall OnOrderSetUpdate(XTAPI::ITTInstrNotify* pNotify,XTAPI::ITTInstrObj* pInstr,XTAPI::ITTOrderSet* pOrderSet);
