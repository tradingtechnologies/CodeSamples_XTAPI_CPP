...
/* Assign the OnPriceListUpdate event
 */
HRESULT CInstrNotifySink::OnPriceListUpdate(XTAPI::ITTInstrNotify *pNotify)
{
	m_pCallback->CInstrNotifySink_PriceList(pNotify);
	return S_OK;
}