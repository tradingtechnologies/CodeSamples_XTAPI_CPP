...
public:
	...
	BEGIN_SINK_MAP(CInstrNotifySink)
		...
		SINK_ENTRY_EX(1,XTAPI::DIID__ITTInstrNotifyEvents, 101,OnNotifyNotFound)
	END_SINK_MAP()
	...
	HRESULT __stdcall OnNotifyNotFound(XTAPI::ITTInstrNotify* pNotify,XTAPI::ITTInstrObj* pInstr);
