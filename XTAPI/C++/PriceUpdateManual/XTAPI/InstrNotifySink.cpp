...
/* Assign the OnNotifyNotFound event
 */
HRESULT CInstrNotifySink::OnNotifyNotFound(XTAPI::ITTInstrNotify* pNotify,XTAPI::ITTInstrObj* pInstr)
{
	// Call the derived class function to service the callback.
	m_pCallback->CInstrNotifySink_NotFound(pInstr);
	return S_OK;
}
