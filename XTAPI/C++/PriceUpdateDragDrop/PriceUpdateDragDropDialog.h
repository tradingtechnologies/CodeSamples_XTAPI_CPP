...
#pragma once
#ifndef PRICEUPDATEDRAGDROPDIALOG_H
#define PRICEUPDATEDRAGDROPDIALOG_H

#include "XTAPI\InstrNotifySink.h"
#include "XTAPI\DropHandlerSink.h"

/* PriceUpdateDragDrop dialog window.  Handles the methods inherited from the 
 * drop handler and instrument notify objects.
 */
class CPriceUpdateDragDropDialog : 
	public CDialog,
...
public:
	...
	CPriceUpdateDragDropDialog(CWnd* pParent = NULL);	

	// Dialog Data
	//{{AFX_DATA(CPriceUpdateDragDropDialog)
	enum { IDD = IDD_PRICEUPDATEDRAGDROP_DIALOG };
	//}}AFX_DATA
...
protected:
	...
	afx_msg void OnBnClickedCheckbid();
	afx_msg void OnBnClickedCheckltp();
	//}}AFX_MSG
...
#endif /* PRICEUPDATEDRAGDROPDIALOG_H */