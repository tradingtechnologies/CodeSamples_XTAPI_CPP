...
/* Empty constructor
 */
CPriceUpdateDragDropApp::CPriceUpdateDragDropApp() { }

/* Marks the beginning of the object map that provides support for the 
 * registration, initialization, and creation of instances of ATL COM classes.
 */
CPriceUpdateDragDropApp theApp;

/* Initialize the XTAPI COM module
 */
BOOL CPriceUpdateDragDropApp::InitInstance()
{
	...
	CPriceUpdateDragDropDialog dlg;
 ...
 */
int CPriceUpdateDragDropApp::ExitInstance()
{
