...
/* Empty constructor
 */
CPriceUpdateMultipleApp::CPriceUpdateMultipleApp() { }

/* Marks the beginning of the object map that provides support for the 
 * registration, initialization, and creation of instances of ATL COM classes.
 */
CPriceUpdateMultipleApp theApp;

/* Initialize the XTAPI COM module
 */
BOOL CPriceUpdateMultipleApp::InitInstance()
{
	...
	CPriceUpdateMultipleDialog dlg;
 ...
 */
int CPriceUpdateMultipleApp::ExitInstance()
{
