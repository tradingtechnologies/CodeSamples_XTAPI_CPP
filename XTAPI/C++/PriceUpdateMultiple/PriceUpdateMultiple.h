...
#pragma once
#ifndef PRICEUPDATEMULTIPLE_H
#define PRICEUPDATEMULTIPLE_H
 ...
 */
class CPriceUpdateMultipleApp : public CWinApp
{
public:
	CPriceUpdateMultipleApp();

	// ClassWizard generated virtual function overrides
	//{{AFX_VIRTUAL(CPriceUpdateMultipleApp)
