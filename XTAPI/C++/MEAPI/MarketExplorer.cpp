...
/* Empty constructor
 */
CMarketExplorerApp::CMarketExplorerApp() { }

/* Marks the beginning of the object map that provides support for the 
 * registration, initialization, and creation of instances of ATL COM classes.
 */
CMarketExplorerApp theApp;

/* Initialize the MEAPI COM module
 */
BOOL CMarketExplorerApp::InitInstance()
{
...
/* Destroy the MEAPI COM module
 */
int CMarketExplorerApp::ExitInstance()
{
