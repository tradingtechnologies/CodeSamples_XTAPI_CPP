...
/* Empty constructor
 */
CPriceUpdateDepthApp::CPriceUpdateDepthApp() { }

/* Marks the beginning of the object map that provides support for the 
 * registration, initialization, and creation of instances of ATL COM classes.
 */
CPriceUpdateDepthApp theApp;

/* Initialize the XTAPI COM module CPriceUpdateDepthDialog
 */
BOOL CPriceUpdateDepthApp::InitInstance()
{
 ...
 */
int CPriceUpdateDepthApp::ExitInstance()
{
