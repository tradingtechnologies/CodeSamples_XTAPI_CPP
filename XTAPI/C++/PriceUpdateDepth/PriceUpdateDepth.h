...
#pragma once
#ifndef PRICEUPDATEDEPTH_H
#define PRICEUPDATEDEPTH_H
 ...
 */
class CPriceUpdateDepthApp : public CWinApp
{
public:
	CPriceUpdateDepthApp();

	// ClassWizard generated virtual function overrides
	//{{AFX_VIRTUAL(CPriceUpdateDepthApp)
